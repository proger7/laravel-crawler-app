...
<div class="container">
    ...
    <div class="input-group-btn form-group d-flex justify-content-between">
        <form action="/logs/search" method="POST" class="js-search-update form-inline ml-auto">
            @csrf
        ...
        <table class="table table-bordered bg-light">
            <thead class="bg-primary">
                <tr>
                    ...
                    <th scope="col" class="fix_width_1">@sortablelink('v_status', 'Status')</th>
                    <th scope="col" class="fix_width_2">@sortablelink('n_parsed_qua', 'Quantity')</th>
                    <th scope="col">@sortablelink('v_url', 'Item\'s URL')</th>
                    <th scope="col">@sortablelink('v_command', 'Command')</th>
...
$(".deleteRecord").click(function() {
    ...
    if(confirm("Are you sure, you want to delete the selected log?")) {
        $.ajax({
            url: '/logs/delete/' + id,
            type: 'DELETE',
            data: {
